...
export const typeFixtures = [
  ...
  translator.messages.campaign.routes['dead-signal'].objectives.allNodes,
  translator.messages.campaign.routes['dead-signal'].objectives.accuracy,
  translator.messages.controls.fire,
  translator.messages.hud.arrayCore,
  translator.messages.results.shieldNodes,
