...
const EXPECTED_CHECKS = {
  ...
  'campaign-contract': [
    'CAMPAIGN.catalog-contract',
    'CAMPAIGN.route-resolution',
  ...
  'localization': [
    ...
    'I18N.event-descriptors',
    'I18N.gate-name-descriptor',
    'I18N.radio-lines',
    'I18N.hud-static-copy',
    'I18N.mfd-canvas-pixels',
    'I18N.mfd-postfx-pixels',
    'I18N.hostile-text',
    'I18N.legacy-fallback',
    'M5.runtime-errors',
    'M6.localhost-only',
  ],
  'localization-hidpi': [
  ...
  'campaign': [
    ...
    'SETUP.page-load',
    'API.contract',
    'CAMPAIGN.fresh-stage-rail',
    'CAMPAIGN.cairn-first-clear',
    'CAMPAIGN.wreckline-handoff',
    'CAMPAIGN.ringfall-final',
    'CAMPAIGN.stage-select-refresh-responsive',
    'CAMPAIGN.direct-production-guards',
    'M5.runtime-errors',
    'M6.localhost-only',
  ],
  'chapter-visual': [
    ...
    'SETUP.page-load',
    'API.contract',
    'CHAPTER_VISUAL.progress',
    'CHAPTER_VISUAL.wreckline-route',
    'CHAPTER_VISUAL.wreckline-signature',
    'CHAPTER_VISUAL.wreckline-destination',
    'CHAPTER_VISUAL.ringfall-route',
    'CHAPTER_VISUAL.ringfall-signature',
    'CHAPTER_VISUAL.ringfall-destination',
    'CHAPTER_VISUAL.title-stage-rail',
    'CHAPTER_VISUAL.results',
    'CHAPTER_VISUAL.exact-set',
    'M5.runtime-errors',
    'M6.localhost-only',
  ],
  'chapter-perf': [
    ...
    'SETUP.page-load',
    'API.contract',
    'CHAPTER_PERF.cairn-drift-dpr1',
    'CHAPTER_PERF.wreckline-dpr1',
    'CHAPTER_PERF.ringfall-dpr1',
    'CHAPTER_PERF.cairn-drift-dpr2',
    'CHAPTER_PERF.wreckline-dpr2',
    'CHAPTER_PERF.ringfall-dpr2',
    'CHAPTER_PERF.six-arm-matrix',
    'M5.runtime-errors',
    'M6.localhost-only',
  ],
  'screenshot-matrix': [
