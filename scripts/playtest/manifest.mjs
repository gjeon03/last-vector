...
const EXPECTED_CHECKS = {
  ...
  'campaign': [
    ...
    'SETUP.page-load',
    'API.contract',
    'CAMPAIGN.harness-default',
    'CAMPAIGN.locked-route-ui',
    'CAMPAIGN.locked-deep-link',
    'CAMPAIGN.authorized-needle-boot',
    'CAMPAIGN.responsive-route-strip',
    'CAMPAIGN.shear-block-feedback',
